...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex justify-around items-center px-2 pb-6 pt-2 bg-white/70 dark:bg-gray-900/75 backdrop-blur-2xl border-t border-white/30 dark:border-white/10">
      {TABS.map(tab => {
